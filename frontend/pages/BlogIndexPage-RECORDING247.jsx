...
export default function BlogIndexPage() {
  ...
  return <article className="archive-page">
    ...
    <HeroVideo compact eyebrow="Archive video" title="See the publishing archive as a living system." body="Topic clusters, search paths, review loops, and monetized placements are designed to move together." />
