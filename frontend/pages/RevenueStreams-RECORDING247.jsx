...
export default function RevenueStreams() {
  return <article className="revenue-page">
    ...
    <HeroVideo compact eyebrow="Revenue video" title="Ad inventory, offers, and trust signals in motion." body="The business model is built from useful content outward: ads, sponsors, templates, services, and network referrals." />
